...
public class InformacionUsuario extends javax.swing.JFrame {
    ...
    public InformacionUsuario() {
        ...
        try {
            ...
            PreparedStatement pst = cn.prepareStatement(
                "select * from esuarios where username = '" + user_update + "'");
            ...
            if (rs.next()) {
                ...
                txt_usarname.setText(rs.getString("username"));
    ...
    private void initComponents() {
        ...
        txt_usarname = new javax.swing.JTextField();
        ...
        txt_usarname.setBackground(new java.awt.Color(153, 153, 255));
        txt_usarname.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_usarname.setForeground(new java.awt.Color(255, 255, 255));
        txt_usarname.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_usarname.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_usarname, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 70, 210, -1));
    ...
    private void jButton_ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarActionPerformed
        ...
        String nombre, mail, telefono, username, pass, permiso_string = "", estatus_string = ";";
        
        mail = txt_mail.getText().trim();
        username = txt_usarname.getText().trim();
        ...
        if (username.equals("")) {
            txt_usarname.setBackground(Color.red);
            validacion++;
        }
        if (nombre.equals("")) {
        ...
        if (validacion == 0) {
            ...
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "select username from esuarios where username = '" + username + "' and not id_usuario = '"
                        + ID + "'");
                ...
                if (rs.next()) {
                    ...
                    PreparedStatement pst2 = cn2.prepareStatement(
                            "update esuarios set nombre_usuario=?, email=?, telefono=?, username=?, tipo_nivel=?, "
    ...
    private javax.swing.JTextField txt_usarname;
