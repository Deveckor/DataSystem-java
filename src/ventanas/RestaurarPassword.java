...
public class RestaurarPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_passwordConfirmafion = new javax.swing.JPasswordField();
        ...
        txt_passwordConfirmafion.setBackground(new java.awt.Color(153, 153, 255));
        txt_passwordConfirmafion.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_passwordConfirmafion.setForeground(new java.awt.Color(255, 255, 255));
        txt_passwordConfirmafion.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_passwordConfirmafion.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_passwordConfirmafion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 210, -1));
    ...
    private void jButton_RestaurarPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_RestaurarPasswordActionPerformed
        ...
        confirmacion_password = txt_passwordConfirmafion.getText().trim();
            ...
            if (password.equals(confirmacion_password)) {
                try {
                    ...
                    PreparedStatement pst = cn.prepareStatement(
                            "update esuarios set password=? where username = '" + user_update + "'");
                    ...
                    txt_passwordConfirmafion.setBackground(Color.GREEN);
                    
                    JOptionPane.showMessageDialog(null, "Restauracion exitosa. ");
                    this.dispose();
                    
                } catch (SQLException e) {
                    System.err.println("Error al ingresar contraseña. " + e);
                }

            } else {
                txt_passwordConfirmafion.setBackground(Color.red);
    ...
    private javax.swing.JPasswordField txt_passwordConfirmafion;
