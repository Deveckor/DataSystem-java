...
public class RegistrarEquipo extends javax.swing.JFrame {
    ...
    public RegistrarEquipo() {
        ...
        try {
            ...
            System.err.println("Error en cargar nombre cliente: " + e);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_RegistrarEquipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 210, 35));
        ...
        if (validacion == 0) {
            try {
                ...
                this.dispose();
                 ...
                 System.err.println("Error al registrar aquipo: " + e);
            JOptionPane.showMessageDialog(null, "Error con la conexion contactar con el administrador.");
            }
        } else {
