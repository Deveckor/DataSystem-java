...
public class Informacion_Cliente extends javax.swing.JFrame {
    ...
    public static int IDequipo = 0, bandera = 0;
    String user = "";
    ...
    public Informacion_Cliente() {
        ...
        try {
            ...
            System.err.println("Error en cargar aquipo: " + e);
            JOptionPane.showMessageDialog(null, "Error con la conexion contactar con el administrador.");
        }
    ...
    private void initComponents() {
        ...
        jButton_ImptimirReporte = new javax.swing.JButton();
        ...
        jButton_ImptimirReporte.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/impresora.png"))); // NOI18N
        jButton_ImptimirReporte.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_ImptimirReporteActionPerformed(evt);
            }
        });
        getContentPane().add(jButton_ImptimirReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 250, 120, 100));
    ...
    private void jButton_ImptimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImptimirReporteActionPerformed
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    System.err.println("Error al obtener datos del equipo" + e);
                }
            ...
            JOptionPane.showMessageDialog(null, "Error al generar Pdf contactar con el administrador");
        }
    }//GEN-LAST:event_jButton_ImptimirReporteActionPerformed
    ...
    private javax.swing.JButton jButton_ImptimirReporte;
